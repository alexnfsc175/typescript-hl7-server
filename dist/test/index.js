...
console.log('sending_application: ', msh.sending_application.namespace_id.value);
console.log('sending_facility: ', msh.sending_facility.namespace_id.value);
console.log('receiving_application: ', msh.receiving_application.namespace_id.value);
